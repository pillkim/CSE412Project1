...
def cornersHeuristic(state, problem):
    ...
    looking at shortest path, prefer manhattan distance, find the shortest distance, x and y distance
    ...
    finding the closest corner using manhattan distance: append the distance to each corner to a list, use min list to find closest corner.
    get corner 
    add manhattan dist to heuristic
    track location when pacman eats food, remove eaten food
    repeat when there's still food left (maybe while loop)
as eat all food, go to closest food
    at the end, find the heuristic value for the problem
    """
